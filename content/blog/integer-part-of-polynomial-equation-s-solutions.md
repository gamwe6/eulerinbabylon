...
In the case of <var>n</var> = 4, there are 12 <var>n</var>-tuples of integers which satisfy both conditions.
We define S(<var>t</var>) as the sum of the absolute values of the integers in <var>t</var>.
